...
* évite les obstacles
* détecte visuellement une cible,
* s’arrête automatiquement dès que la cible est trouvée.

Le système est basé sur ROS 2 (Robot Operating System) et repose sur une architecture modulaire claire
